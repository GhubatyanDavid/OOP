        ...
        static void Main(string[] args)
        {
            ...
            if(amountCheck == true)
            {
                ...
                if(depositAmount < 100)
                {
                    ...
                    Console.WriteLine($"1 year percent will be`{oneYearPercent},5 year percent will be`{fiveYearPercent},10 year percent will be`{tenYearPercent}");
                    Console.WriteLine($"1 year Money will be`{depositAmount+oneYearPercent},5 year Money will be`{depositAmount+fiveYearPercent},10 year will be`{depositAmount+tenYearPercent}");
                }
